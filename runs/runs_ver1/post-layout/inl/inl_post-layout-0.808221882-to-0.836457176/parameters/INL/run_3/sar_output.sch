...
C {devices/vsource.sym} -960 -420 0 0 {name=VVin value="DC 0.829398353" savecurrent=false}
...
device=resistor
m=1}
C {devices/code_shown.sym} -2120 -760 0 0 {name=SETUP only_toplevel=false value="* CACE gensim simulation file sar_output_3
...
C {devices/vsource.sym} -680 -420 0 0 {name=VCLK value="PULSE(1.8 0 0 100p 100p 1u 2u)" savecurrent=false}
C {devices/vsource.sym} -510 -420 0 0 {name=VEN value="PULSE(1.8 0 0 100ps 100ps 1u 0)" savecurrent=false}
