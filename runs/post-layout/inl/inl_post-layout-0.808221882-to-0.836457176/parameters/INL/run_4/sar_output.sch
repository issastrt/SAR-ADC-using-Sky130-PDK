...
C {devices/vsource.sym} -960 -420 0 0 {name=VVin value="DC 0.836457176" savecurrent=false}
...
device=resistor
m=1}
C {devices/code_shown.sym} -2120 -760 0 0 {name=SETUP only_toplevel=false value="* CACE gensim simulation file sar_output_4
