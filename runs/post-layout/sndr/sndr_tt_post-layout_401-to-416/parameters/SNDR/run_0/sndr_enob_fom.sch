...
.endc
"}
C {devices/code_shown.sym} -1630 -560 0 0 {name=SETUP only_toplevel=false value="* CACE gensim simulation file sndr_enob_fom_0
...
C {devices/vsource.sym} -750 -160 0 0 {name=VVin value="SIN(0.9 0.85 229.7794 0 0 281.25)" savecurrent=false}
