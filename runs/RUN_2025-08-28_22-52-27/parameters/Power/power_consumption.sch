...
tran 0.5u 136u uic
set wr_singlescale
wrdata CACE\{simpath\}/CACE\{filename\}_CACE\{N\}.data -I(VVDD) V(Vin)
quit
.endc
"}
...
C {devices/vsource.sym} -750 -160 0 0 {name=VVin value="PWL(0 0 34u 0 34.00001u 0.6 68u 0.6 68.00001u 1.2 102u 1.2 102.00001u 1.8 136u 1.8)" savecurrent=false}
