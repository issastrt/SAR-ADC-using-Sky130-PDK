...
.endc
"}
C {devices/code_shown.sym} -1630 -560 0 0 {name=SETUP only_toplevel=false value="* CACE gensim simulation file power_consumption_28
...
C {devices/vsource.sym} -750 -160 0 0 {name=VVin value="DC 0.225" savecurrent=false}
