...
.endc
"}
C {devices/code_shown.sym} -1630 -560 0 0 {name=SETUP only_toplevel=false value="* CACE gensim simulation file transient_9
...
C {devices/vsource.sym} -750 -160 0 0 {name=VVin value="DC 1.7999999999999998" savecurrent=false}
