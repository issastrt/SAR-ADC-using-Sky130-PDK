...
- [DRC Results](data/DRC%20Results.out) — design rule check report generated by Magic.  
- [LVS Results](data/LVS%20Results.out) — layout versus schematic verification report generated by Netgen.  
...
## Python/MATLAB Codes Used for Computation
