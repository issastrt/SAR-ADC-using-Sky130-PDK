...
C {vsource.sym} -1330 210 0 0 {name=VCLK value="PULSE(1.8 0 0 500p 500p 2u 4u)" savecurrent=false}
...
C {vsource.sym} -1090 210 0 0 {name=VEN value="PULSE(1.8 0 0 500ps 500ps 2u 0)" savecurrent=false}
...
C {vsource.sym} -1040 -170 0 0 {name=VVin value=0.1 savecurrent=false}
